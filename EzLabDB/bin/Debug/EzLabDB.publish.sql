...
GO
PRINT N'Creating Table [dbo].[Components]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '58885453-1f52-470a-9474-4f451545fad7')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('58885453-1f52-470a-9474-4f451545fad7')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'f50d4dbe-0a13-4225-afa4-4466091acfdd')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('f50d4dbe-0a13-4225-afa4-4466091acfdd')
