...
GO
/*
The column [dbo].[User].[passhash] is being dropped, data loss could occur.

The column [dbo].[User].[hash] on table [dbo].[User] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
ALTER TABLE [dbo].[Client] DROP CONSTRAINT [FK__Client__user_id__5535A963];
...
GO
ALTER TABLE [dbo].[Employee] DROP CONSTRAINT [FK__Employee__user_i__5629CD9C];
